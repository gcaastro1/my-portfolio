        ...
        <section className={styles.about}>
            <div className={`${styles.about__container} container`}>
                <div className={styles.about__content}>
                    ...
                    Passionate about art and innovation, always looking for new knowledge. I worked for 4 years in the area of digital product design. I&apos;m always looking to improve my skills and knowledge to create better experiences for users. And I&apos;m currently specializing in web development.
                    <br /><br />
